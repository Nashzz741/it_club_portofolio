...
const structureData = {
  pembina: {
    ...
    transform: { scale: 1.2, x: "0%", y: "5%", fit: "cover" },
  ...
  executives: [
    {
      ...
      transform: { scale: 1.2, x: "25%", y: "-10%", fit: "cover" },
    ...
    },
    {
      ...
      transform: { scale: 1.4, x: "10%", y: "-17%", fit: "cover" },
  ...
  adminAndFinance: [
    {
      ...
      transform: { scale: 1.4, x: "-5%", y: "-15%", fit: "cover" },
    ...
    },
    {
      ...
      transform: { scale: 1.4, x: "0%", y: "5%", fit: "cover" },
    ...
    },
    {
      ...
      // Menggunakan fit: "contain" agar foto tinggi/potret tampil utuh tanpa terpotong
      transform: { scale: 1, x: "0%", y: "15%", fit: "contain" },
      icon: <Wallet className="w-5 h-5 text-emerald-400" />,
    },
  ],
  divisions: [
    {
      ...
      transform: { scale: 1.4, x: "0%", y: "-14%", fit: "cover" },
    ...
    },
    {
      ...
      transform: { scale: 1.3, x: "5%", y: "-12%", fit: "cover" },
      icon: <ClipboardCheck className="w-5 h-5 text-indigo-400" />,
    },
    {
      ...
      transform: { scale: 1.0, x: "5%", y: "19%", fit: "cover" },
